...
class CommonMedicines {
  static const List<MedicineDefaults> defaults = [
    ...
    MedicineDefaults(name: 'Aspirin', typeIcon: 1, color: 0xFFFFFFFF),
    ...
    MedicineDefaults(name: 'Augmentin', typeIcon: 1, color: 0xFFFFFFFF),
    MedicineDefaults(name: 'Azithromycin', typeIcon: 1, color: 0xFFAB47BC),
    MedicineDefaults(name: 'Ciprofloxacin', typeIcon: 1, color: 0xFFFFFFFF),

    // Chronic
    MedicineDefaults(name: 'Metformin', typeIcon: 1, color: 0xFFFFFFFF),
    MedicineDefaults(name: 'Lipitor', typeIcon: 1, color: 0xFFFFFFFF),
    MedicineDefaults(name: 'Omeprazole', typeIcon: 1, color: 0xFFAB47BC),
    MedicineDefaults(name: 'Amlodipine', typeIcon: 1, color: 0xFFFFFFFF),
    ...
    MedicineDefaults(name: 'Magnesium', typeIcon: 1, color: 0xFFFFFFFF),
    
    // Allergies
    MedicineDefaults(name: 'Zyrtec', typeIcon: 1, color: 0xFFFFFFFF),
    MedicineDefaults(name: 'Claritin', typeIcon: 1, color: 0xFFFFFFFF),
